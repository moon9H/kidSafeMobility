...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='data/Custom/custom_set')
    parser.add_argument(
        '--out_folder', default='data/Custom/custom_set')
    arg = parser.parse_args()

    part = ['train', 'val']
    for p in part:
        data_path = '{}/custom_{}'.format(arg.data_path, p)
        label_path = '{}/custom_{}_label.json'.format(arg.data_path, p)
